...
class DataQuality():
    ...
    def backup_great_expectations_db(self):
        
        '''
        back up great expectation database to azure blob storage.
        '''
        
        dbutils.fs.cp('dbfs:/great_expectations', 'dbfs:/mnt/marketingdb/great_expectations', recurse=True)
    ...
    def update_data_lineage(self):
        ...
        if self.data_lineage_sdf:
            ...
            (
                ...
                .format('delta')
                .mode('append')
                .save("/mnt/marketingdb/data_lineage")
            )
